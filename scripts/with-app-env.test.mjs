...
test("this workspace ships no app-env override (dev matches deployed: auth on)", () => {
...
test("the wrapped command runs with this workspace's app env applied (no override → auth on)", async () => {
